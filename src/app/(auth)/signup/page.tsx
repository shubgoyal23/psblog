  ...
  const router = useRouter()
   ...
   const onSubmit: SubmitHandler<Inputs> = (data) => {
      axios
         ...
         .then((res) => {
          toast.success("User creation successful! Please proceed to log in to continue.");
          router.push("/login")})
         .catch((error) => {
                     ...
                     <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
                        <div className="flex gap-2">
                           <div className="flex-1">
                              ...
                              <input
                                 type="text"
                                 className="block mt-2 w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm outline-none placeholder:text-gray-400 focus:ring-2 focus:ring-black focus:ring-offset-1"
